            ...
            <Card disHover class="g-unit right">
              <span slot="title">
                ...
                <span class="m-details">
                  <a :href="'/#/articles'" @click="scrollTop">所有文章</a>&nbsp;&nbsp;|&nbsp;
                  <a class="m-details" :href="'/#' + moment.extras.href" @click="scrollTop">查 看</a>
                </span>
              </span>
              <div class="m-unit">
          ...
          <div v-if="moment.type === 'resource'" class="m-moment g-unit">
            ...
            <Card disHover class="g-unit right">
              <span slot="title">
                ...
                <strong>{{moment.desc}}</strong>
                <span class="m-details">
                  <a :href="'/#/resources'" @click="scrollTop">所有文件</a>&nbsp;&nbsp;|&nbsp;
...
<script>
  import { Menu, MenuItem, Timeline, TimelineItem, Card, Icon, Tag } from 'iview';
  ...
  export default {
    ...
    components: {
      Menu, MenuItem, Timeline, TimelineItem, Card, Icon, Tag
    },
    data () {
      return {
        moments: [],
    ...
    methods: {
      ...
      fetchMoments (mode) {
        let _this = this;
        let type = mode || 'all';
        this.$ajax.get('/api/moment/fetch?type=' + type + '&limit=' + this.limit).then(function (res) {
      ...
      refreshLabelList () {
        let _this = this;
        this.$ajax.post('/api/label/query', {}).then(function (res) {
