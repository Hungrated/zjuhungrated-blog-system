...
<script>
  import { Icon, Modal, Button, RadioGroup, Radio, Input } from 'iview';

  export default {
    name: 'user-center-profile',
    components: {
      Icon, Modal, Button, RadioGroup, Radio, iInput: Input
    },
    data () {
      return {
        profileMng: false,
...
//          user_id: null
    ...
    methods: {
      ...
      editAvatar () {
        ...
        this.$ajax.post('/api/profile/modify', profileData).catch(function (e) {
          console.log(e);
        });
      ...
      profileSubmit () {
        ...
        this.$ajax.post('/api/profile/modify', profileData).then(function (res) {
      ...
      avatarSubmit () {
        ...
        this.myCroppa.generateBlob((blob) => {
          ...
          this.$ajax.post('/api/profile/avatar', formData, this.uploadConfig).then(function (res) {
            _this.$Message.success(res.data.msg);
