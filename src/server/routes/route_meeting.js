 ...
 * }
 */
router.post('/submit', validate.validateTeacher, function (req, res) { // publish a Meeting(project or event)
 ...
 * ]
 */
router.post('/query', validate.validateUser, function (req, res) { // publish a Meeting(project or event)
  Meeting.findAll({
    where: {
